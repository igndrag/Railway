...
public abstract class railCircuitAutopilot implements Autopilot{
    ...
    public railCircuitAutopilot(Locomotive locomotive, LocomotiveController locomotiveController) {
